...
<form action="<?php echo url("aanmeld.process")?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <div>
                        <input type="radio" name="gender"  value="<?php echo input('female')?>" class="form-input" id="gender" >Vrouw
                    </div>
                    <div>
                        <input type="radio" name="gender"  value="<?php echo input('male')?>" class="form-input" id="gender" >Man
                    </div>
                    <div>
                        <input type="radio" name="gender" value="<?php echo input('niet-zeggen')?>" class="form-input" id="gender" >Zeg ik liever niet
                    </div>
